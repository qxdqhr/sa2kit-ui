          ...
          <View className="sa2-phone-home">
            <View className="sa2-phone-date">
              <View className="sa2-phone-date-header">
                <Image src={PHONE_STATUS_ICONS.wifi} className="sa2-phone-wifi" mode="aspectFit" />
                <Text>
                  {displayHours}
                ...
                <Image src={PHONE_STATUS_ICONS.location} className="sa2-phone-location" mode="aspectFit" />
              </View>
            ...
            <View className="sa2-phone-page-indicator">
              <Image src={PHONE_STATUS_ICONS.page} className="sa2-phone-page" mode="aspectFit" />
            </View>
          </View>
        </View>
      </View>
