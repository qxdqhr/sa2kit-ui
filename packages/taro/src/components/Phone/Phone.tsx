          ...
          <View className="ai-phone-home">
            <View className="ai-phone-date">
              <View className="ai-phone-date-header">
                <Image src={PHONE_STATUS_ICONS.wifi} className="ai-phone-wifi" mode="aspectFit" />
                <Text>
                  {displayHours}
                ...
                <Image src={PHONE_STATUS_ICONS.location} className="ai-phone-location" mode="aspectFit" />
              </View>
            ...
            <View className="ai-phone-page-indicator">
              <Image src={PHONE_STATUS_ICONS.page} className="ai-phone-page" mode="aspectFit" />
            </View>
          </View>
        </View>
      </View>
