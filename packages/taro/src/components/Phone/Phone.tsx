          ...
          <View className="sa2-phone-home-screen">
            <View className="sa2-phone-date-display">
              <View className="sa2-phone-date-header">
                <Image src={PHONE_STATUS_ICONS.wifi} className="sa2-phone-icon-wifi" mode="aspectFit" />
                <Text>
                  {displayHours}
                ...
                <Image src={PHONE_STATUS_ICONS.location} className="sa2-phone-icon-location" mode="aspectFit" />
              </View>
            ...
            <View className="sa2-phone-page-indicator">
              <Image src={PHONE_STATUS_ICONS.page} className="sa2-phone-icon-page" mode="aspectFit" />
            </View>
          </View>
        </View>
      </View>
